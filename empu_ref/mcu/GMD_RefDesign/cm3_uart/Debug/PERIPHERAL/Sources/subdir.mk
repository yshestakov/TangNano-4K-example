...
PERIPHERAL/Sources/%.o: ../PERIPHERAL/Sources/%.c
	...
	arm-none-eabi-gcc -mcpu=cortex-m3 -mthumb -O3 -fmessage-length=0 -fsigned-char -ffunction-sections -fdata-sections  -g3 -I"D:\Downloads\sipeed-nano-4k\Gowin EDA\Gowin_EMPU(GW1NS-4C)_V1.1.2\ref_design\MCU_RefDesign\GMD_RefDesign\cm3_uart\CORE" -I"D:\Downloads\sipeed-nano-4k\Gowin EDA\Gowin_EMPU(GW1NS-4C)_V1.1.2\ref_design\MCU_RefDesign\GMD_RefDesign\cm3_uart\PERIPHERAL\Includes" -I"D:\Downloads\sipeed-nano-4k\Gowin EDA\Gowin_EMPU(GW1NS-4C)_V1.1.2\ref_design\MCU_RefDesign\GMD_RefDesign\cm3_uart\SYSTEM" -I"D:\Downloads\sipeed-nano-4k\Gowin EDA\Gowin_EMPU(GW1NS-4C)_V1.1.2\ref_design\MCU_RefDesign\GMD_RefDesign\cm3_uart\USER" -std=gnu11 -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@)" -c -o "$@" "$<"
