...
PERIPHERAL/Sources/%.o: ../PERIPHERAL/Sources/%.c
	...
	arm-none-eabi-gcc -mcpu=cortex-m3 -mthumb -O3 -fmessage-length=0 -fsigned-char -ffunction-sections -fdata-sections  -g3 -I"C:\GMD\workspace\cm3_hyper_ram\CORE" -I"C:\GMD\workspace\cm3_hyper_ram\PERIPHERAL\Includes" -I"C:\GMD\workspace\cm3_hyper_ram\SYSTEM" -I"C:\GMD\workspace\cm3_hyper_ram\USER" -std=gnu11 -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@)" -c -o "$@" "$<"
