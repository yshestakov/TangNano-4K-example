...
PERIPHERAL/Sources/%.o: ../PERIPHERAL/Sources/%.c
	...
	arm-none-eabi-gcc -mcpu=cortex-m3 -mthumb -O3 -fmessage-length=0 -fsigned-char -ffunction-sections -fdata-sections  -g3 -I"C:\GMD\workspace\cm3_keyscan\CORE" -I"C:\GMD\workspace\cm3_keyscan\PERIPHERAL\Includes" -I"C:\GMD\workspace\cm3_keyscan\SYSTEM" -I"C:\GMD\workspace\cm3_keyscan\USER" -std=gnu11 -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@)" -c -o "$@" "$<"
